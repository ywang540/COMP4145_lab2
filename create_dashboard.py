...
data = generate_sample_data()  # Use sample data directly
...
stats = {
    ...
    'targetReached': len(positions[positions['SellReason'] == 'Target reached']),
    'maxPeriodExits': len(positions[positions['SellReason'] == 'Max holding period'])
}
        ...
        <div id="tab-0" class="tab-content active">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="value">${data['Close'].iloc[-1]:.2f}</div>
                </div>
                <div class="stat-card">
                    <div class="label">50-Day MA</div>
                    <div class="value">${data['MA50'].iloc[-1]:.2f}</div>
                </div>
                <div class="stat-card">
                    <div class="label">200-Day MA</div>
                    <div class="value">${data['MA200'].iloc[-1]:.2f}</div>
                </div>
            </div>
        </div>
        ...
        <div id="tab-1" class="tab-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="value">{stats['winRate']:.2f}%</div>
                </div>
                <div class="stat-card">
                    <div class="label">Average Profit</div>
                    <div class="value">{stats['avgProfit']:.2f}%</div>
                </div>
                <div class="stat-card">
                    <div class="label">Total Return</div>
                    <div class="value">{stats['totalReturn']:.2f}%</div>
                </div>
                <div class="stat-card">
                    <div class="label">Winning Trades</div>
                    <div class="value">{stats['winTrades']}</div>
                </div>
                <div class="stat-card">
                    <div class="label">Losing Trades</div>
                    <div class="value">{stats['lossTrades']}</div>
                </div>
                <div class="stat-card">
                    <div class="label">Average Win</div>
                    <div class="value">{stats['avgWin']:.2f}%</div>
                </div>
                <div class="stat-card">
                    <div class="label">Average Loss</div>
                    <div class="value">{stats['avgLoss']:.2f}%</div>
                </div>
            </div>
...
html_content += """
    ...
    <script>
        ...
        function showTab(index) {
            ...
            // Draw charts when tab 1 is selected
        ...
        function drawProfitChart() {
            ...
            const trace = {
                x: Array.from({length: profits.length}, (_, i) => i + 1),
                y: profits,
                type: 'histogram',
                nbinsx: 15,
                marker: {color: '#5b9fff'}
...
print("Open 'trading_dashboard.html' in your web browser to view the dashboard.")
